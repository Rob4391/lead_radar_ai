...
import { buildProposalPrompt, parseProposalResponse, ProposalLead, ProposalResult } from './prompt';
...
export class ProposalService {
    ...
    async generateProposal(lead: ProposalLead): Promise<ProposalResult> {
        ...
        try {
            ...
            this.logger.error(`Failed to parse proposal response: ${(err as Error).message}`);
            throw err;
        }
    }
}
